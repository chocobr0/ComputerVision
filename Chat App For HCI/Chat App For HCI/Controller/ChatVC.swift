...
//        }
    ...
    override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!) {
        let info = senderId + " " + DateFormatter.localizedString(from: Date(), dateStyle: .short, timeStyle: .medium)
        MessagesHandler.Instance.sendMessage(senderID: info, senderName: senderDisplayName, text: text);
